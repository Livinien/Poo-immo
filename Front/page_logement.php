    ...
    <div class="card-body">
        <h2 class="card-title">Villa de Luxe</h2>
            <h4 class="card-subtitle mt-3">Surface 3500 m2 au total</h4>
                <h4 class="card-subtitle "> prix: 1 000 000 €</h4>
    </div>

    <div class="card-body">
        <h2 class="card-title">Caractéristiques</h2>
            <h4 class="card-subtitle mt-3">Type de logement: Villa, Maison</h4>
                <h4 class="card-subtitle"> Nombre de Pièces: T6 </h4>
                <h4 class="card-subtitle"> Surface: 200 m2 surface intérieur avec un jardin de 3000 m2 + piscine. </h4>
                <h4 class="card-subtitle"> Localisation: Nice, FRANCE </h4>
    </div>
    <div class="card-body">
        <h2 class="card-title">Description</h2>
            <h4 class="card-subtitle mt-3">Villa face à la mer avec piscine, se situant sur les hauteurs. Coin tranquille sans vis-à-vis situé dans la résidence huppé de Nice.
                ...
                <h4 class="card-subtitle"> A proximité des commerces, de la plage, du centre-ville, etc... </h4>
